...
def visualize_vertex_vs_center(filename='data/penrose_lattice_data.npz'):
    ...
    plt.tight_layout()
    plt.savefig('imgs/vertex_vs_center_model.png', dpi=300)
